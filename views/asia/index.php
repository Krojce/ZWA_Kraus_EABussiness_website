...
<div class="jumbotron" id="asia">

	<div class="container">

		<h1><?php echo $asia_jumbotron_h1; ?></h1>

		<p>

			<?php echo $asia_jumbotron_paragraph1; ?><br><?php echo $asia_jumbotron_paragraph2; ?>
...
<div class="container">
  ...
  <h2>
    ...
    <?php echo $asia_main_h1?>

  </h2>

  <p>

    <?php echo $asia_main_paragraph1?>
    ...
    <div class="col-md-12 post-alignment">
      ...
      <div class="col-xs-8 col-sm-3">
        ...
        <a href="<?php echo $item['link']; ?>">
          ...
          <img alt="<?php echo $item['image_name']; ?>" class="logo-img" src="/assets/images/logos/<?php echo $item['image_name']; ?>">
      ...
      <div class="col-xs-4 col-sm-9">
        ...
        <?php if(isset($_SESSION['is_logged_in_admin'])) : ?>
          ...
          <a class="edit" href="<?php echo ROOT_PATH; ?>shares/edit/?id=<?php echo $item['id']?>">
            ...
            <img alt="edit-logo" src="/assets/images/edit.jpg">
